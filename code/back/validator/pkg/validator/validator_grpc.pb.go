...
const (
	ValidatorService_ValidateSpecification_FullMethodName = "/validator.ValidatorService/ValidateSpecification"
	ValidatorService_GetHello_FullMethodName              = "/validator.ValidatorService/GetHello"
)
...
func (c *validatorServiceClient) ValidateSpecification(ctx context.Context, in *ValidateSpecificationRequest, opts ...grpc.CallOption) (*ValidationResult, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(ValidationResult)
	err := c.cc.Invoke(ctx, ValidatorService_ValidateSpecification_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *validatorServiceClient) GetHello(ctx context.Context, in *GetHelloRequest, opts ...grpc.CallOption) (*GetHelloResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetHelloResponse)
	err := c.cc.Invoke(ctx, ValidatorService_GetHello_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (UnimplementedValidatorServiceServer) ValidateSpecification(context.Context, *ValidateSpecificationRequest) (*ValidationResult, error) {
	return nil, status.Errorf(codes.Unimplemented, "method ValidateSpecification not implemented")
}
func (UnimplementedValidatorServiceServer) GetHello(context.Context, *GetHelloRequest) (*GetHelloResponse, error) {
...
func _ValidatorService_ValidateSpecification_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(ValidateSpecificationRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ValidatorServiceServer).ValidateSpecification(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ValidatorService_ValidateSpecification_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ValidatorServiceServer).ValidateSpecification(ctx, req.(*ValidateSpecificationRequest))
	}
	return interceptor(ctx, in, info, handler)
}

func _ValidatorService_GetHello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetHelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ValidatorServiceServer).GetHello(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ValidatorService_GetHello_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ValidatorServiceServer).GetHello(ctx, req.(*GetHelloRequest))
	}
	return interceptor(ctx, in, info, handler)
}
	...
	Methods: []grpc.MethodDesc{
		{
			...
			Handler:    _ValidatorService_ValidateSpecification_Handler,
		},
		{
			MethodName: "GetHello",
			Handler:    _ValidatorService_GetHello_Handler,
		},
	},
